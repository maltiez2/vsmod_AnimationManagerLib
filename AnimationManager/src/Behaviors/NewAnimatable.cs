...
public class NewAnimatable : CollectibleBehavior, ITexPositionSource // Based on code from TeacupAngel (https://github.com/TeacupAngel)
{
    ...
    public NewAnimatable(CollectibleObject collObj) : base(collObj)
    {
    }
    ...
    public override void OnLoaded(ICoreAPI api)
    {
        ...
        if (api is ICoreClientAPI clientApi)
        {
            ...
            mClientApi.Event.RegisterItemstackRenderer(collObj, RenderHandFp, EnumItemRenderTarget.HandTp);
            mClientApi.Event.RegisterItemstackRenderer(collObj, RenderHandFp, EnumItemRenderTarget.HandFp);
            mClientApi.Event.RegisterItemstackRenderer(collObj, RenderHandFp, EnumItemRenderTarget.HandTpOff);
        }
    }
    ...
    {
        Console.WriteLine("RenderHandFp");

        if (false && onlyWhenAnimating && ActiveAnimationsByAnimCode.Count == 0 && !RenderProceduralAnimations)
        {
